import type { ResponseType as CreateAssetGroupForUserCommandResponse } from "@finance/application/build/commands/assets/createAssetGroupForUserCommand";
import type { ResponseType as CreateRealEstateAssetForUserCommandResponse } from "@finance/application/build/commands/assets/createRealEstateAssetForUserCommand";
import type { ResponseType as CreateStockAssetForUserCommandResponse } from "@finance/application/build/commands/assets/createStockAssetForUserCommand";
import type { ResponseType as GetAssetGroupQueryResponse } from "@finance/application/build/queries/assets/getAssetGroupQuery";
import type { ResponseType as GetAssetGroupsForUserQueryResponse } from "@finance/application/build/queries/assets/getAssetGroupsForUserQuery";
import type { ResponseType as GetAssetQueryResponse } from "@finance/application/build/queries/assets/getAssetQuery";
import type { ResponseType as GetAssetsForUserQueryResponse } from "@finance/application/build/queries/assets/getAssetsForUserQuery";
